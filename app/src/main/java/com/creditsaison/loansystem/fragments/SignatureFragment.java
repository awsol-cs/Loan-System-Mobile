...
public class SignatureFragment extends Fragment {
    ...
    View view;
    SignatureFragment.signature mSignature;
    Bitmap bitmap;
            ...
            if (v == mClear) {
                ...
                if (Build.VERSION.SDK_INT > 23) {
                    ...
                    if (currentPage == "termsCondition"){
                        ...
                        Navigation.findNavController(v).navigate(R.id.action_signatureFragment_to_promiNoteFragment);
                    }
    ...
    public boolean isStoragePermissionGranted() {
        if (Build.VERSION.SDK_INT >= 23) {
            if (getActivity().getApplicationContext().checkSelfPermission(Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED) {
                return true;
            } else {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mContent = (LinearLayout) binding.getRoot().findViewById(R.id.canvasLayout);
        mSignature = new SignatureFragment.signature(getActivity().getApplicationContext(), null);
        mSignature.setBackgroundColor(Color.WHITE);
        // Dynamically generating Layout through java code
        mContent.addView(mSignature, ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
        mClear = (Button) binding.getRoot().findViewById(R.id.clear);
        mGetSign = (Button) binding.getRoot().findViewById(R.id.getsign);
        mGetSign.setEnabled(false);
        mCancel = (Button) binding.getRoot().findViewById(R.id.cancel);
        view = mContent;
